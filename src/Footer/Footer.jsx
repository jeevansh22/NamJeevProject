      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-white text-xl font-bold transition hover:opacity-75"> Address </a>
              <h3 className="text-slate-200">67/B, Netaji Subhas Road 2nd Floor, Room No. 45, Kolkata-700001
              Phone</h3>
            </li>

            <li>
            <a href="#" className="text-white text-xl font-bold transition hover:opacity-75"> Phone </a>
              <h3 className="text-slate-200">+91 993377 7444</h3>
            </li>

            <li>
            <a href="#" className="text-white text-xl font-bold transition hover:opacity-75"> Mail </a>
              <h3 className="text-slate-200">marketing@savcosales.com</h3>
            </li>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm ml-10">
            <li>
              <a href="#" className=" transition hover:opacity-75 text-slate-200"> Home </a>
            </li>

            <li>
              <a href="#" className="text-slate-200 transition hover:opacity-75"> About us </a>
            </li>

            <li>
              <a href="#" className="text-slate-200 transition hover:opacity-75"> Download Catalogue </a>
            </li>
            
            <li>
              <a href="#" className="text-slate-200 transition hover:opacity-75"> Contatc Us </a>
            </li>
          </ul>
        </div>
