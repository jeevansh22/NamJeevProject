            ...
            <div className="data w-full lg:pr-8 pr-0 xl:justify-start justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
              <div className="data w-full max-w-xl">
                ...
                <p className="text-gray-500 text-base font-normal mb-5">
                  The satake milling separator SFI is an all purpose separator
                  for the cleaning of cereal grains ,such as rice ,wheat, maize,
                  soya,rye, oats,etc. The oscilliation of the double deck sieves
                  efficiently removes both large or coarse material, and fine
                  impurities from the grain being efficient removed. The SFI is
                  available as a silo rice (elevator) Intake separator for high
                  capacities and as a milling separator, to provide more precise
                  separation. The SFI can be used with a simple exhaust or can
                  be matched to either as SCA closed circuit aspirator or an
                  open circuit aspirator.
                </p>
